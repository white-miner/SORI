...
-- shops.tier_badge 타입 변경 전, 해당 컬럼을 참조하는 뷰 제거 (ERROR 0A000)
...
-- community_shared_cases 복구 (031 정의, enum 컬럼은 text로 노출)
...
comment on view public.community_shared_cases is
  'PII-safe community B/A feed projection (shop_tier_badge as text).';
